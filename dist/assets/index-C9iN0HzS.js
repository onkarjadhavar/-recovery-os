(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const d of o.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&s(d)}).observe(document,{childList:!0,subtree:!0});function a(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(n){if(n.ep)return;n.ep=!0;const o=a(n);fetch(n.href,o)}})();const f={transient_upi:{transaction_id:"pay_O78zKL92pXQ12a",amount:1499,merchant_id:"merch_lenskart",customer_id:"cust_82193",timestamp:"2026-09-04T14:32:05Z",detection_event:"Payment Failed (UPI - GATEWAY_TIMEOUT)",failure_code:"GATEWAY_TIMEOUT",failure_category:"TRANSIENT",diagnosis_explanation:"Transient inter-bank latency / switch timeout on UPI. Verified customer with 7 prior successful payments (CLV: ₹15,400). Failure is non-behavioral; auto-retry scheduled with jitter.",ai_confidence:.98,recommended_action:"RETRY_PAYMENT",policy_approved:!0,policy_checks:[{rule_name:"PERMANENT_FAILURE_STOP",passed:!0,threshold_applied:"Not permanent reject",observed_value:"TRANSIENT",details:"Transient network issue"},{rule_name:"FRAUD_RISK_BOUNDARY",passed:!0,threshold_applied:"Risk Score < 0.35",observed_value:"Risk: 0.03",details:"Clean history"},{rule_name:"MAX_RETRY_BUDGET",passed:!0,threshold_applied:"Attempts <= 2",observed_value:"Attempt #1",details:"Budget available"},{rule_name:"AUTO_RECOVERY_AMOUNT_CAP",passed:!0,threshold_applied:"Amount <= ₹5,000",observed_value:"₹1,499.00",details:"Within autonomous boundary"},{rule_name:"AI_CONFIDENCE_GATE",passed:!0,threshold_applied:"Confidence >= 85%",observed_value:"98.0%",details:"High diagnostic confidence"}],final_action:"RETRY_PAYMENT",execution_result:"Success: Razorpay Smart Retry executed at optimal jitter. Simulated Payment Captured (₹1,499.00).",amount_recovered:1499,gateway_fee_saved:0},high_value_risk:{transaction_id:"pay_K992vV01aBB34z",amount:42e3,merchant_id:"merch_electronics_hub",customer_id:"cust_unknown_new",timestamp:"2026-09-04T14:38:12Z",detection_event:"Payment Failed (CARD - HIGH_RISK_SUSPECTED)",failure_code:"HIGH_RISK_SUSPECTED",failure_category:"SECURITY_RISK",diagnosis_explanation:"High-risk anomaly: risk score 0.78 breaches platform baseline. 0 prior successful transactions, multiple rapid declines. Automated intervention prohibited.",ai_confidence:.84,recommended_action:"ESCALATE_TO_HUMAN",policy_approved:!1,policy_checks:[{rule_name:"PERMANENT_FAILURE_STOP",passed:!0,threshold_applied:"Not permanent reject",observed_value:"SECURITY_RISK",details:"Security risk classification"},{rule_name:"FRAUD_RISK_BOUNDARY",passed:!1,threshold_applied:"Risk Score < 0.35",observed_value:"Risk: 0.78",details:"Flagged: Risk score breached ceiling"},{rule_name:"MAX_RETRY_BUDGET",passed:!0,threshold_applied:"Attempts <= 2",observed_value:"Attempt #2",details:"Under attempt cap"},{rule_name:"AUTO_RECOVERY_AMOUNT_CAP",passed:!1,threshold_applied:"Amount <= ₹5,000",observed_value:"₹42,000.00",details:"Escalated: Value exceeds autonomous limit"},{rule_name:"AI_CONFIDENCE_GATE",passed:!1,threshold_applied:"Confidence >= 85%",observed_value:"84.0%",details:"Below confidence threshold"}],final_action:"ESCALATE_TO_HUMAN",execution_result:"Action Blocked: High value (₹42,000.00), risk (0.78) & low AI confidence (84%). Quarantined for Human Review.",amount_recovered:0,gateway_fee_saved:3.5},permanent_failure:{transaction_id:"pay_X441pL88qWW77k",amount:890,merchant_id:"merch_zomato_pay",customer_id:"cust_11094",timestamp:"2026-09-04T14:41:20Z",detection_event:"Payment Failed (CARD - CARD_EXPIRED)",failure_code:"CARD_EXPIRED",failure_category:"PERMANENT_REJECT",diagnosis_explanation:"Permanent instrument rejection (CARD_EXPIRED). Immediate termination required to eliminate wasted gateway authorization fees and merchant penalties.",ai_confidence:.99,recommended_action:"DO_NOTHING",policy_approved:!1,policy_checks:[{rule_name:"PERMANENT_FAILURE_STOP",passed:!1,threshold_applied:"Must not be permanent reject",observed_value:"PERMANENT_REJECT",details:"Immediate halt on expired card"},{rule_name:"FRAUD_RISK_BOUNDARY",passed:!0,threshold_applied:"Risk Score < 0.35",observed_value:"Risk: 0.02",details:"Clean user history"},{rule_name:"MAX_RETRY_BUDGET",passed:!0,threshold_applied:"Attempts <= 2",observed_value:"Attempt #1",details:"Under retry limit"},{rule_name:"AUTO_RECOVERY_AMOUNT_CAP",passed:!0,threshold_applied:"Amount <= ₹5,000",observed_value:"₹890.00",details:"Under limit"},{rule_name:"AI_CONFIDENCE_GATE",passed:!0,threshold_applied:"Confidence >= 85%",observed_value:"99.0%",details:"Deterministic error"}],final_action:"DO_NOTHING",execution_result:"Action Suppressed: Permanent failure (CARD_EXPIRED). Wasted gateway retry fee (₹3.50) avoided.",amount_recovered:0,gateway_fee_saved:3.5},cart_dropoff:{transaction_id:"pay_C331rT77jHH99b",amount:3250,merchant_id:"merch_boat_lifestyle",customer_id:"cust_49201",timestamp:"2026-09-04T14:45:00Z",detection_event:"Cart Abandoned (UPI - CART_DROPOFF)",failure_code:"CART_DROPOFF",failure_category:"CART_ABANDONMENT",diagnosis_explanation:"Checkout funnel drop before gateway transition. Intent is warm. Generating time-bounded Razorpay Smart Checkout link with 15-minute lock.",ai_confidence:.93,recommended_action:"SEND_PAYMENT_LINK",policy_approved:!0,policy_checks:[{rule_name:"PERMANENT_FAILURE_STOP",passed:!0,threshold_applied:"Not permanent reject",observed_value:"CART_ABANDONMENT",details:"Intent recoverable"},{rule_name:"FRAUD_RISK_BOUNDARY",passed:!0,threshold_applied:"Risk Score < 0.35",observed_value:"Risk: 0.05",details:"Low risk"},{rule_name:"MAX_RETRY_BUDGET",passed:!0,threshold_applied:"Attempts <= 2",observed_value:"Attempt #1",details:"First attempt"},{rule_name:"AUTO_RECOVERY_AMOUNT_CAP",passed:!0,threshold_applied:"Amount <= ₹5,000",observed_value:"₹3,250.00",details:"Within autonomous boundary"},{rule_name:"AI_CONFIDENCE_GATE",passed:!0,threshold_applied:"Confidence >= 85%",observed_value:"93.0%",details:"Confidence threshold met"}],final_action:"SEND_PAYMENT_LINK",execution_result:"Success: Razorpay Payment Link dispatched via SMS/Email (Link ID: plink_7jHH99b). Simulated Payment Captured (₹3,250.00).",amount_recovered:3250,gateway_fee_saved:0}},C="https://backend-two-chi-94.vercel.app",l=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?"http://127.0.0.1:8000":window.location.origin&&window.location.origin.includes("vercel.app")?window.location.origin:C,R=document.getElementById("liveTraceView"),L=document.getElementById("traceTimestamp"),E=document.querySelectorAll(".scenario-btn"),O=document.getElementById("transactionTableBody"),T=document.getElementById("filterCodeSelect"),D=document.getElementById("refreshFeedBtn"),B=document.getElementById("runFullBenchmarkBtn"),u=document.getElementById("traceModal");document.getElementById("modalTxnId");document.getElementById("modalTraceContent");const x=document.getElementById("closeModalBtn"),r=document.getElementById("benchmarkExplainerModal"),y=document.getElementById("openBenchmarkExplainerBtn"),h=document.getElementById("closeBenchmarkModalBtn"),c=document.getElementById("docsModal"),A=document.getElementById("openDocsModalBtn"),g=document.getElementById("closeDocsModalBtn");let N="transient_upi";document.addEventListener("DOMContentLoaded",()=>{U(),b(N),v(),P()});function U(){E.forEach(e=>{e.addEventListener("click",()=>{E.forEach(a=>a.classList.remove("active")),e.classList.add("active");const t=e.getAttribute("data-scenario");N=t,b(t)})}),T.addEventListener("change",()=>v()),D.addEventListener("click",()=>v()),B.addEventListener("click",()=>w()),x.addEventListener("click",()=>{u.classList.remove("open")}),y&&y.addEventListener("click",()=>{r.classList.add("open")}),h&&h.addEventListener("click",()=>{r.classList.remove("open")}),A&&A.addEventListener("click",e=>{e.preventDefault(),c.classList.add("open")}),g&&g.addEventListener("click",()=>{c.classList.remove("open")}),window.addEventListener("keydown",e=>{e.key==="Escape"&&(u.classList.remove("open"),r&&r.classList.remove("open"),c&&c.classList.remove("open"))}),[u,r,c].forEach(e=>{e&&e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})})}async function b(e){R.innerHTML='<div class="trace-loading">Dispatching Razorpay event & running policy check...</div>';try{const t=await fetch(`${l}/api/simulate-preset`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({scenario:e})});if(t.ok){const a=await t.json();p(a.decision_trace)}else p(f[e])}catch{p(f[e])}}function p(e){L.textContent=`Audit: ${e.audit_timestamp||new Date().toISOString()}`;const t=e.policy_approved;e.amount_recovered>0;const a=e.final_action==="ESCALATE_TO_HUMAN"||!t&&e.final_action!=="DO_NOTHING",s=e.final_action==="DO_NOTHING";let n="success",o=`&#10003; RECOVERY ACTION EXECUTED &amp; VERIFIED (SIMULATED) &bull; &#8377;${e.amount_recovered.toLocaleString("en-IN")}`,d=e.execution_result;a?(n="blocked",o="&#128737;&#65039; BLOCKED BY POLICY GUARDRAIL &bull; HUMAN REVIEW REQUIRED",d="Automated execution blocked BEFORE money movement. Quarantined for supervisor review."):s&&(n="halted",o="&#128721; HALTED &bull; PERMANENT FAILURE STOP RULE (FEE SAVED)",d="Zero payment attempts made. Futile gateway retry fee avoided.");const m=Math.round((e.ai_confidence||.9)*100);let _="";a?_=`
      <div class="why-not-card">
        <div class="why-not-title">&#9888;&#65039; WHY WAS THIS PAYMENT NOT AUTO-RECOVERED?</div>
        <ul class="why-not-list">
          ${e.amount>5e3?`<li><strong>Amount Limit Breached:</strong> Amount &#8377;${e.amount.toLocaleString("en-IN")} exceeds autonomous limit (&#8377;5,000.00).</li>`:""}
          ${e.policy_checks.some(i=>i.rule_name==="FRAUD_RISK_BOUNDARY"&&!i.passed)?"<li><strong>Risk Safety Ceiling Breached:</strong> Transaction risk score exceeds platform safety boundary (&lt; 0.35).</li>":""}
          ${e.ai_confidence<.85?`<li><strong>Confidence Gate Breached:</strong> AI diagnostic confidence (${m}%) is below minimum 85% safety gate.</li>`:""}
        ...
        <div class="step-body">
          ...
          <div class="step-box">
            ...
            <div class="confidence-meter">
              ...
              <span class="confidence-val">${m}%</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="step-body">
          ...
          <div class="step-box">
            <div style="font-size: 0.75rem; color: var(--text-muted); margin-bottom: 0.35rem;">
              AI Recommended Action: <code style="color: var(--razorpay-accent);">${e.recommended_action}</code> &bull; Hard Boundary Checks:
            </div>
  ...
  `;R.innerHTML=k}async function P(){try{const e=await fetch(`${l}/api/benchmarks`);if(e.ok){const t=await e.json();S(t)}}catch{console.log("Using cached benchmark display values")}}function S(e){if(!e)return;document.getElementById("statAtRisk").textContent=`₹${(e.at_risk_amount/1e7).toFixed(2)} Cr`,document.getElementById("statRecovered").textContent=`₹${(e.recoveryos_recovered_amount/1e7).toFixed(2)} Cr`,document.getElementById("statRecRate").textContent=`+${e.recoveryos_recovery_rate}% rate`,document.getElementById("statRiskBlocked").textContent=`${e.recoveryos_high_risk_actions_blocked.toLocaleString("en-IN")}`,document.getElementById("statFeesSaved").textContent=`₹${e.recoveryos_gateway_fees_saved.toLocaleString("en-IN")}`;const t=document.getElementById("benchmarkTableBody");t.innerHTML=`
    <tr>
